    ...
    public class DatabaseContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            var Studio1 = new GameStudio
            {
                ...
                StudioPicturePath = $"/images/Studios/{studioGuidHelper}/{studioGuidHelper}.png",
            };
            ...
            var Studio2 = new GameStudio
            {
                ...
                StudioPicturePath = $"/images/Studios/{studioGuidHelper}/{studioGuidHelper}.jpg",
            };
            ...
            var Publisher1 = new Publisher
            {
                ...
                PublisherPicturePath =
                    $"/images/Publishers/{publisherGuidHelper}/{publisherGuidHelper}.jpg",
            };
            ...
            var Publisher3 = new Publisher
            {
                ...
                PublisherPicturePath =
                    $"/images/Publishers/{publisherGuidHelper}/{publisherGuidHelper}.png",
            };
            ...
            var VideoGameInfo4 = new VideoGameInfo
            {
                ...
                GamePicturePath =
                    $"/images/Games/{videoGamesInfoGuidHelper}/{videoGamesInfoGuidHelper}.png",
            };
